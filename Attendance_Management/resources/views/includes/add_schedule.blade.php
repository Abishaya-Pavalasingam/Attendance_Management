        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('schedule.store') }}">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label" >Course </label>
                            ...
                            <div class="bootstrap-timepicker">
                                <input type="text" class="form-control timepicker" id="name" name="slug" placeholder="Enter Coursename_Coursecode">
                            </div>
                        
                    </div>
                    <div class="form-group">
                        <label for="time_in" class="col-sm-3 control-label">Start</label>
                    ...
                    <div class="form-group">
                        <label for="time_out" class="col-sm-3 control-label">end</label>
