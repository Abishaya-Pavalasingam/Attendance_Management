...
<div class="modal fade" id="edit{{ $student->name }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title"><b><span class="student_id">Edit Students</span></b></h4>
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('students.update', $student->name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="position" name="position" value="{{ $student->position }}"
                            required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header " style="align-items: center">
              ...
              <h4 class="modal-title "><span class="student_id">Delete Students</span></h4>
