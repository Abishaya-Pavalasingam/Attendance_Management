...
<div class="modal fade" id="edit{{ $schedule->slug }}">
    <div class=" modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title"><b>Update Course</b></h4>
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('schedule.update', $schedule->slug) }}">
                    ...
                    <div class="form-group">
                        <label for="edit_time_in" class="col-sm-3 control-label">start </label>
                    ...
                    <div class="form-group">
                        <label for="edit_time_out" class="col-sm-3 control-label">end</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header " style="align-items: center">
                ...
                <h4 class="modal-title "><span class="student_id">Delete Course</span></h4>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('schedule.destroy', $schedule->slug) }}">
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="bold del_student_name">{{ $schedule->slug}}</h2>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i
