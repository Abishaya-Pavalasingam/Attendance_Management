                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li class="">
                                <a href="{{route('admin')}}" class="waves-effect {{ request()->is("admin") || request()->is("admin/*") ? "mm active" : "" }}">
                                    <i class="ti-home"></i><span class="badge badge-success badge-pill float-right"></span> <span> Dashboard </span>
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="/students" class="waves-effect {{ request()->is("students") || request()->is("/students/*") ? "mm active" : "" }}"><i class="dripicons-view-apps"></i><span>Students List</span></a>
                                    </li>
                            ...
                            <li class="">
                                <a href="/schedule" class="waves-effect {{ request()->is("schedule") || request()->is("schedule/*") ? "mm active" : "" }}">
                                    <i class="ti-book"></i> <span> Courses </span>
                                </a>
                            </li>
                            <li class="">
