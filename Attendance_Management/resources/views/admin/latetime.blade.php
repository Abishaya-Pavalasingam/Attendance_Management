...
@section('button')
<a href="/attendance" class="btn btn-success btn-sm btn-flat"><i class="mdi mdi-plus mr-2"></i>Attendance Table</a>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $latetime->stu_id }}</td>
                                    <td>{{ $latetime->atudent->name }}</td>
                                    <td>{{ $latetime->duration }}</td>
                                    <td>{{ $latetime->atudent->schedules->first()->time_in }} </td>
                                    <td>{{ $latetime->atudent->schedules->first()->time_out }}</td>
                                </tr>
