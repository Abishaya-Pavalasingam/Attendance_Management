...
@endsection
@section('button')
    <a href="/leave" class="btn btn-success btn-sm btn-flat"><i class="mdi mdi-table mr-2"></i>Leave Table</a>
                                ...
                                <tbody>
                                    @foreach ($overtimes as $overtime)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $overtime->stu_id }}</td>
                                            <td>{{ $overtime->student->name }}</td>
                                            <td>{{ $overtime->duration }} </td>
                                            <td>{{ $overtime->student->schedules->first()->time_in }} </td>
                                            <td>{{ $overtime->student->schedules->first()->time_out }}</td>
                                        </tr>
